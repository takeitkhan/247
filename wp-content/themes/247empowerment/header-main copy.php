    ...
    <header class="custom-navbar">
        <div class="d-flex align-items-center justify-content-between m-0 p-0 w-100 h-100 container">
            ...
            <nav class="navbar">
                ...
                <!-- 🔴 CHANGE 1: removed d-none / d-lg-* utilities -->
                <!-- 🔴 CHANGE 2: desktop-menu class used for CSS control -->
            ...
            <div class="d-flex align-items-center gap-1 gap-md-3">
                ...
                <!-- 🔴 CHANGE 3: removed d-lg-none -->
                <!-- 🔴 CHANGE 4: menu-toggle class for breakpoint control -->
                <button class="btn btn-light menu-toggle" id="menuToggle">
        ...
        <!-- MOBILE MENU -->
        <!-- 🔴 CHANGE 5: removed d-lg-none -->
        <!-- 🔴 CHANGE 6: mobile-menu controlled by CSS + JS -->
        <div class="bg-white shadow-sm mobile-menu" id="mobileMenu">
